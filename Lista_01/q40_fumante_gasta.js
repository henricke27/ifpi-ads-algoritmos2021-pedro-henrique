    ...
    var ultima_carteira = parseInt((carteiras_consumidas - parseInt(carteiras_consumidas)) + 0.9)
    var dinheiro_gasto = parseInt(carteiras_consumidas * valor_carteira) + ultima_carteira
